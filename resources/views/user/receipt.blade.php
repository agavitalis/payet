                    ...
                    <section class="content invoice">
                      ...
                      <div class="row">
                        <div class="col-xs-12 invoice-header">
                          <h1>
                             <i class="fa fa-money"></i> E-FEES RECEIPT.
                      ...
                      <div class="row invoice-info">
                        <div class="col-sm-4 invoice-col">
                          From
                            <address>
                                <strong>E-FEES, Inc.</strong>
                                <br>Phone:+234 81 639 22749
                                <br>Email: info@e_feesplatform.com
                            </address>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                        ...
                        <div class="col-sm-4 invoice-col">
                          ...
                          <br>
                          <b>Payment date:</b> {{$transaction->created_at}}
                          <br>
                          <b>Wallet ID:</b> {{$transaction->transaction_benefit}}
                        </div>
                        <!-- /.col -->
                      </div>
                      <!-- /.row -->
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-6">
                          ...
                          <img src="../images/carrd.png" height="75px"width="150px" alt="Visa">
                        ...
                        <div class="col-xs-6">
                          ...
                          <div class="table-responsive">
                            ...
                            ...payment and accountability made easy
                          </p>
                          </div>
                        </div>
                        <!-- /.col -->
