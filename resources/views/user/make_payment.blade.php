          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i>Choose your prefered payment option <small>(pay with cards or through wallets)</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        ...
                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Pay through My Wallets</a>
                        </li>
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" >
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="text" class="form-control has-feedback-left" id="p_wallet" placeholder="Receiver Wallet ID">
                                        <span class="fa fa-credit-card form-control-feedback left" aria-hidden="true"></span>
                                    </div>

                                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                        <input type="number" class="form-control" id="p_amount" placeholder="Amount">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <textarea class="form-control" rows="3" id="p_summary" placeholder='Transaction Summary'></textarea>
                                        </div>
                                    </div>
                             ...
                             <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left input_mask" method="POST" action="{{ route('make_payment')}}">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                        <input type="text" class="form-control"required  name="w_receiver" placeholder="Receiver Wallet ID">
                                        <span class="fa fa-folder-open form-control-feedback right" aria-hidden="true"></span>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12 col-sm-12 col-xs-12 pull-right">
                                            <button class="btn btn-primary  pull-right" type="reset">Reset</button>
                                            <button type="submit" class="btn btn-success  pull-right">Complete Payment</button>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#p_pay').click(function(){
                ...
                if( $('#p_fname').val()==""|| $('#p_lname').val()=="" || $('#p_email').val()=="" || $('#p_phone').val()=="" || $('#p_wallet').val()=="" || $('#p_amount').val()=="" || $('#p_summary').val()=="")
                {
                                ...
                                if ( response.tx.chargeResponseCode == "00" || response.tx.chargeResponseCode == "0"  ) {
                                    ...
                                    $.ajax({
                                        ...
                                        success:function(data){
                                            ...
                                            $('.p_message').text("Your payment completed successfully..");
                                        }
                                    })
